...
open class WorkStageListResponseResults : RealmObject() {
    @PrimaryKey
    var _id: String? = null
    ...
    var stages: RealmList<StageListResponseResults>? = null
    var paymentstages: RealmList<PaymentStagesResults>? = null
