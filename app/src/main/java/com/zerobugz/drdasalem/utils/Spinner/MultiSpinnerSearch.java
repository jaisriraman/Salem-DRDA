...
public class MultiSpinnerSearch extends AppCompatSpinner implements OnCancelListener {
    ...
    public void setItemsList(List<KeyPairBoolData> items, int position, SpinnerListener listener) {
    ...
    public class MyAdapter extends BaseAdapter implements Filterable {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                convertView = inflater.inflate(R.layout.spinneritem_listview_multiple, parent, false);
            ...
            final int backgroundColor = (position % 2 == 0) ? R.color.white : R.color.white;
