...
class WorkOrderList : AppCompatActivity() {
...
//        getSchemaList()
    ...
    private fun getBeneficiaryList(yearid: String, schemeId: String, panjayatId: String) {
        ...
        }).getBeneficiaryList(beneficiaryRequest)
    }
    ...
    private fun setRecyclerAdapter() {
        ...
        val rResponseResults = realm!!.where<BeneficiaryListResponseResults>().findAll()
        if (rResponseResults.size > 0) {
            ...
            recyclerView.bind(realmResults, R.layout.workorder_recycler_view_item) {
                ...
                if (item.workorderdate != null && item.workorderdate!!.isNotEmpty()) {
                    ...
                    mAction.setOnClickListener {
                        ...
                        val intent = Intent(this@WorkOrderList, AddWorkOrder::class.java)
            ...
            }.layoutManager(LinearLayoutManager(this@WorkOrderList))
        } else {
    ...
    private fun setSearchRecyclerAdapter(text: String) {
        ...
        val rResponseResults = realm!!.where<BeneficiaryListResponseResults>()
