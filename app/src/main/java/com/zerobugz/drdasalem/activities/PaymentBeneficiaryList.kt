...
class PaymentBeneficiaryList : AppCompatActivity() {
    private var realm: Realm? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_beneficiary_payment_list)
        realm = try {
...
//        getSchemaList()
        ...
        ivBack.setOnClickListener {
            val intent = Intent(this@PaymentBeneficiaryList, MainActivity::class.java)
...
//        swipeRefresh.isRefreshing = true
        ...
        }).getPaymentBeniciaryList(beneficiaryRequest)
    }
    ...
    private fun setRecyclerAdapter() {
        ...
        val rResponseResults = realm!!.where<BeneficiaryPaymentListResponseResults>().findAll()
        if (rResponseResults.size > 0) {
            ...
            recyclerView.bind(realmResults, R.layout.workorder_recycler_view_item) {
                ...
                if (item.workorderdate != null && item.workorderdate!!.isNotEmpty()) {
                    ...
                    mAction.setOnClickListener {
                        ...
                        val intent = Intent(this@PaymentBeneficiaryList, AddBilling::class.java)
                    ...
                    mAction.text = "Add"
                    mAction.setOnClickListener {
                        val intent = Intent(this@PaymentBeneficiaryList, AddWorkOrder::class.java)
            ...
            }.layoutManager(LinearLayoutManager(this@PaymentBeneficiaryList))
        } else {
    ...
    private fun setSearchRecyclerAdapter(text: String) {
        ...
        val rResponseResults = realm!!.where<BeneficiaryPaymentListResponseResults>()
